...
export const referenceServerSixAxisProfile: RobotVisualProfile = Object.freeze({
  ...
  joints: Object.freeze([
    { visualJointId: 'base', axis: { browseName: 'SAxis', expectedMotionDevice: 'single-device-scope', required: true, unit: 'angular' }, direction: 1, zeroOffsetRadians: 0, scale: 1 },
    { visualJointId: 'shoulder', axis: { browseName: 'LAxis', expectedMotionDevice: 'single-device-scope', required: true, unit: 'angular' }, direction: 1, zeroOffsetRadians: -65 * Math.PI / 180, scale: 1 },
    { visualJointId: 'elbow', axis: { browseName: 'UAxis', expectedMotionDevice: 'single-device-scope', required: true, unit: 'angular' }, direction: 1, zeroOffsetRadians: 75 * Math.PI / 180, scale: 1 },
    { visualJointId: 'wrist1', axis: { browseName: 'RAxis', expectedMotionDevice: 'single-device-scope', required: true, unit: 'angular' }, direction: 1, zeroOffsetRadians: 0, scale: 1 },
    { visualJointId: 'wrist2', axis: { browseName: 'BAxis', expectedMotionDevice: 'single-device-scope', required: true, unit: 'angular' }, direction: 1, zeroOffsetRadians: 0, scale: 1 },
    { visualJointId: 'wrist3', axis: { browseName: 'TAxis', expectedMotionDevice: 'single-device-scope', required: true, unit: 'angular' }, direction: 1, zeroOffsetRadians: 0, scale: 1 },
  ]),
