...
export type SnapshotValue={label:string;browseName:string;nodeId:string;statusCode:string;valueText:string;discovery:string;dataType?:string|null;sourceTimestamp?:string|null;serverTimestamp?:string|null;engineeringUnits?:string|null;engineeringUnit?:EngineeringUnitMetadata|null;euRange?:string|null;euRangeMetadata?:EuRangeMetadata|null;engineeringUnitsRaw?:string|null;euRangeRaw?:string|null;stableKey?:string|null;motionDeviceKey?:string|null;axisKey?:string|null;lastGoodValueText?:string;lastGoodSourceTimestamp?:string|null;lastGoodServerTimestamp?:string|null;lastGoodUpdatedAt?:number};
export type SnapshotSection={name:string;values:SnapshotValue[]};
export type MotionInventoryAxis={axis:DiscoveryNode;motionDeviceKey:string;stableKey:string;actualPosition?:SnapshotValue|null;diagnostics:string[]};
export type MotionInventoryDevice={motionDevice:DiscoveryNode;axes:MotionInventoryAxis[];diagnostics:string[]};
export type MotionInventory={robotIdentity:string;motionDeviceSystems:{system:DiscoveryNode;motionDevices:MotionInventoryDevice[]}[];diagnostics:string[]};
export type Snapshot={connected:boolean;endpointUrl:string;generatedAtUtc:string;sections:SnapshotSection[];warnings:string[];motionInventory?:MotionInventory|null};
export type Node={browseName:string;displayName:string;nodeId:string;typeDefinition:string;evidence:string};
export type DiscoveryNode={browseName:string;displayName:string;nodeId:string;typeDefinition:string;evidence:string;stableKey?:string|null;namespaceUri?:string|null};
